...
async function generateCommand(i){//actual iteration
    ...
    if(i===0){
        ...
        command = `docker run --name db${i} -p300${3*(i-1)+1}:7474 -p300${3*(i-1)+2}:7473 -p300${3*(i-1)+3}:7687 -d -v /db${i}/data:/data -v /db${i}/logs:/logs -v /db${i}/conf:/conf --env NEO4J_AUTH=none neo4j`;
    }
